...
/* ===============================================
   STEP 10: Multiple Linear Regression with Covariates
   =============================================== */
proc glm data=work.math_final_clean;
    class grant_participant;
    model avg_percent_meets = grant_participant 
                              'Percent Economically Disadvantag'n 
                              'Percent Emergent Bilingual'n;
    title "MLR: Avg % Meets vs Grant Status + Demographics";
run;
